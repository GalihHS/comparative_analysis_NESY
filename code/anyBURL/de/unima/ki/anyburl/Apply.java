	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			if (Settings.PREDICTION_TYPE.equals("aRx")) {
				...
				Settings.PATH_SAT = IOHelper.getProperty(prop, "PATH_SAT", Settings.PATH_SAT);
		...
		if (Settings.PREDICTION_TYPE.equals("aRx")) {
			...
			for (String value : values) {
				...
				String path_sat = Settings.PATH_SAT;
				...
				RuleEngine.applyRulesARX(rules, path_sat, testSet, trainingSet, validSet, Settings.TOP_K_OUTPUT, pw);
