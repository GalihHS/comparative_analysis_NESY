...
class SelectHiddenTriples(object):
    ...
    def eval(self,use_cuda, cuda, model_path, top_k_threshold=0.1):
        if use_cuda:
            cmd = 'CUDA_VISIBLE_DEVICES={} python3 ./kge/run.py --cuda ' \
            ...
            cmd = 'python3 ./kge/run.py --do_score_calculation ' \
