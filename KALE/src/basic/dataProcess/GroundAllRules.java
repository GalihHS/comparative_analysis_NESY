...
//			Integer iSndRelation = LstRuleTypeII.get(iFstRelation);		
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length != 1) {
			System.err.println("please define the dataset folder, wn18 or fb122 or family");
			System.exit(1);
		}
		...
		String fnRules = "datasets/" + datasetFolder + "/" + datasetFolder + "_rule";
		String fnTrainingTriples = "datasets/" + datasetFolder + "/train.txt";
		//Output file:
        String fnOutput = "datasets/" + datasetFolder + "/groundings.txt";
